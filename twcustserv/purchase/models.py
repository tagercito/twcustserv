...
class Purchase(models.Model):
    ...
    #price_categories = models.ManyToManyField('shows.PriceCategory',
    ...
    br_name = models.CharField(_('Card name'), max_length=255, blank=True,
                               null=True)
    expiry = models.CharField(_('Card expiry'), max_length=10, blank=True,
                              null=True)
