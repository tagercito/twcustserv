...
class Transaction(models.Model):
    ...
    where = models.SmallIntegerField(_('performance location title line number'),
                                     blank=True, null=True)
    who = models.SmallIntegerField(_('performer title line number'),
                                   blank=True, null=True)
    when = models.SmallIntegerField(_('performance date title line number'),
                                    blank=True, null=True)
    ...
    def __str__(self):
        return ' - '.join([self.fmj_date, str(self.tnum)])
